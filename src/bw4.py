...
def main():
    ...
    parser.add_argument('-r', '--rule', type=int, help="The rule number of automata to use (can change with arrow keys while running)", default=52)
    ...
    automata = FourBitAutomata(args.width, args.height, args.rule, args.distribution, args.narrow)
    automata.run()
